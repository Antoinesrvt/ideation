          ...
          <div className="flex items-center">
            ...
            <Tooltip>
              ...
              <TooltipContent className="max-w-sm backdrop-blur-sm">
                <p className="text-sm">
                  User journey maps visualize the steps a user takes when
                  interacting with your product, including their thoughts,
              ...
              <CardContent className="p-4">
                ...
                <ul className="space-y-2 text-sm text-dark-600">
                  <li className="flex items-start">
                    ...
                    <span>
                      <strong className="font-medium text-primary-700">
                        Focus on users:
                      </strong>{" "}
                      Create journey maps from the perspective of specific user
                      personas.
                    </span>
                  </li>
                  <li className="flex items-start">
                    ...
                    <span>
                      ...
                      Record user sentiment at each stage to identify pain
                      points.
                    </span>
                  </li>
                  <li className="flex items-start">
                    ...
                    <span>
                      ...
                      List all interactions between the user and your product.
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-primary-600 mr-2">•</span>
                    <span>
                      ...
                      Use the journey map to find areas for product improvement.
                    </span>
                  </li>
                </ul>
              </CardContent>
          ...
          <Card variant="default" className="border-dashed border-gray-300">
            <CardContent className="p-8 flex flex-col items-center justify-center text-center">
              ...
              <p className="text-dark-500 max-w-sm mb-4">
                Journey maps help visualize how users interact with your product
            ...
            <div className="flex justify-between relative z-10">
              {sortedStages.map((stage, index) => (
                ...
                >
                      ...
                      <div className="mt-2 flex justify-between items-center">
                        <HoverCard>
                          ...
                          <HoverCardContent className="w-56 p-3 text-xs backdrop-blur-sm">
                            ...
                            <p>
                              How the user feels during this stage of their
                              journey.
                            </p>
                          </HoverCardContent>
                        </HoverCard>
                  ...
                  <Badge
                    variant="outline"
                    className="mt-2 bg-white text-xs px-2"
                  >
