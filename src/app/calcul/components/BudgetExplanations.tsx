  ...
  return (
    <>
      <div>
        ...
        <p className="text-sm">
          Les recettes sont calculées sur la base du PIB français (environ 2500
          milliards €) :
        </p>
        <ul className="list-disc pl-6 text-sm space-y-2 mt-2">
          ...
          <li>Impôt sur les sociétés : calculé sur 30% du PIB (bénéfices)</li>
      ...
      <div>
        ...
        <p className="text-sm">
          Les dépenses sont basées sur les grands postes budgétaires de l'État :
        </p>
        <ul className="list-disc pl-6 text-sm space-y-2 mt-2">
          <li>Protection sociale (retraites, santé) : environ 50% du budget</li>
          ...
          <li>Autres dépenses (culture, recherche, etc.) : reste du budget</li>
        </ul>
      </div>
      ...
      <div>
        ...
        <ul className="list-disc pl-6 text-sm space-y-2 mt-2">
          <li>
            Les interactions entre paramètres ne sont pas modélisées (ex: impact
            d'une hausse de TVA sur la consommation)
          </li>
          <li>Certaines recettes et dépenses sont simplifiées ou omises</li>
          <li>
            Les données réelles peuvent varier selon les années et les méthodes
            de calcul
          </li>
          <li>
