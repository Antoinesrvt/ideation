  ...
  theme: {
  	extend: {
  		...
  		keyframes: {
  			...
  			ripple: {
  				'0%': {
  					boxShadow: '0 0 0 0 rgba(114, 9, 183, 0.3), 0 0 0 0.5rem rgba(114, 9, 183, 0.2), 0 0 0 1rem rgba(114, 9, 183, 0.1)'
  				},
  				'100%': {
  					boxShadow: '0 0 0 0.5rem rgba(114, 9, 183, 0.2), 0 0 0 1rem rgba(114, 9, 183, 0.1), 0 0 0 1.5rem rgba(114, 9, 183, 0)'
  				}
  			},
  			'text-shimmer': {
  				'0%': {
